...
const mockSummary: PersonalizedSummary = {
  ...
  relevantAreas: [
    {
      ...
      relevanceScore: 92,
      summary: "New public housing developments and rental assistance programs that directly benefit your profile.",
      details: "Based on your housing type and income range, you qualify for several new housing initiatives including the Enhanced Rental Assistance Scheme and priority allocation for new public housing units in your district.",
      actionItems: [
    ...
    },
    {
      ...
      relevanceScore: 78,
      summary: "New MTR extensions and bus route improvements affecting your daily commute.",
      details: "The new MTR line extension will reduce your commute time by approximately 15 minutes daily. Additional bus routes in your district will provide more flexible transportation options.",
      actionItems: [
    ...
    },
    {
      ...
      details: "New community health centers and telemedicine services will improve healthcare accessibility in your district. Enhanced elderly care services may benefit family members.",
      actionItems: [
  ...
  majorUpdates: [
    ...
    },
    {
      ...
      description: "City-wide digital transformation including 5G networks and smart traffic systems.",
      relevanceToUser: "Will improve digital services and reduce traffic congestion in your area.",
      timeline: "2024-2026",
      impact: "low"
    }
  ],
  recommendations: [
    ...
    },
    {
      ...
      description: "Review and update your transportation methods to take advantage of new routes and discounts.",
      actionSteps: [
