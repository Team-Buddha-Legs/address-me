      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              <ArrowDownTrayIcon className="h-4 w-4" />
              <span>
                {isDownloading ? "Generating Text..." : "Download Text"}
              </span>
            </button>
          </div>

          <p className="text-xs text-neutral-500 mt-2">
            Files will be saved with the format: policy-summary-{reportId}
            -YYYY-MM-DD.pdf/txt
          </p>
        </div>
        ...
        <div className="border-t border-neutral-200 pt-4">
          ...
          <p className="text-sm text-neutral-600 mb-3">
            Has your situation changed? Retake the assessment to get an updated
        ...
        <div className="border-t border-neutral-200 pt-4">
          <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
            ...
            <p className="text-sm text-primary-dark leading-relaxed">
              Bookmark this page or download your report to reference your
              personalized recommendations later. Policy implementations may
              take time, so check back periodically for updates.
            </p>
          </div>
        </div>
      </div>
