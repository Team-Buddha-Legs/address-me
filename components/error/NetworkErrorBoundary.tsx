...
function NetworkErrorFallback({ error, resetError }: NetworkErrorFallbackProps) {
      ...
      >
        ...
        >
          <p className="text-xs text-gray-500">
            Your assessment progress is saved locally and will be restored when the connection is available.
          </p>
        </motion.div>
      </motion.div>
    </div>
...
export default function NetworkErrorBoundary({ children, onError }: NetworkErrorBoundaryProps) {
  return (
